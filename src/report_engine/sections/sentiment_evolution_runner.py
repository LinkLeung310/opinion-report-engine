"""Fault-isolated execution of the sentiment-evolution report section."""
...
class SentimentEvolutionRepository(Protocol):
    def fetch(self, scope: AnalysisScope) -> SentimentEvolutionSnapshot: ...


class SentimentEvolutionChartBuilder(Protocol):
    def build(
        self,
...
class SentimentEvolutionSectionRunner:
    def __init__(
        self,
        repository: SentimentEvolutionRepository,
