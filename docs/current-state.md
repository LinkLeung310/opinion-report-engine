...
- 事务隔离基线之后的英文 19 章矩阵、代表性任意组合、OpenAI-compatible narrator 与 CatalogPublisher 已在各自独立本地功能分支完成并合入 `codex/local-integration`；M3 已在 `codex/m3-api-local` 完成实现与本地验收，待本小步提交后合入本地集成分支。
