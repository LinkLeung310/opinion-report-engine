...
- `docs/source/2026-07-11-舆情报告生成模块 — 开发任务书.md`：面试方原文，只保存固定契约、核心要求、里程碑和工作约定。
...
- `docs/requirements-traceability.md`：任务书条款到实现与验证证据的映射。
...
1. 读取 `AGENTS.md`、任务书、`current-state` 和本步相关设计；检查分支与脏工作区。
